...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sv43tsu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sv43tsu.containers.anotherwebservice.com/
...
```
git clone git@github.com:B3zza/container-sv43tsu.git
cd container-sv43tsu
```
...
```
docker attach container-sv43tsu
```
